...
if sys.argv[1] == 'isp':
    ...
    # while loading page
    while driver.find_element_by_xpath('/html/body/div[1]/div/div[1]/div'):
        pass
    ...
    driver.find_element_by_xpath('/html/body/div[1]/div/div[5]/ul/div[5]/ul/div[1]/ul/div[1]').click()
